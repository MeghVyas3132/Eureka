...
class Planogram(Base):
    ...
    generation_level: Mapped[str] = mapped_column(String(50), nullable=False, default="basic")
    generation_method: Mapped[str] = mapped_column(String(50), nullable=False, default="heuristic")
    shelf_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    shelf_width_cm: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    shelf_height_cm: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
