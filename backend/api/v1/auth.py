...
from schemas.auth import AuthResponseData, LoginRequest, RefreshRequest, RegisterRequest
...
async def register(payload: RegisterRequest, db: AsyncSession = Depends(get_db)) -> dict:
    ...
    return success_response(response_data.model_dump(mode="json"), "User registered successfully.")
